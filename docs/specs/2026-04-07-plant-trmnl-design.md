...
**1-plant reference:** `[redacted-path]/Downloads/trmnl-1-plant-BjV-4oWY.png`
**2-plant reference:** `[redacted-path]/Downloads/trmnl-2-plants-Bn2iYAZV.png`
...
**Normal rest day reference:** `[redacted-path]/Downloads/trmnl-rest-day-DTZXFqYo.png`
**Overdue rest day reference:** `[redacted-path]/Downloads/trmnl-rest-day-overdue-CQA6HVEc.png`
...
|--------|------------|-----------|
| Watering day (1 plant) | `[redacted-path]/Downloads/trmnl-1-plant-BjV-4oWY.png` | `docs/mockups/watering-1-plant.png` |
| Watering day (2 plants) | `[redacted-path]/Downloads/trmnl-2-plants-Bn2iYAZV.png` | `docs/mockups/watering-2-plants.png` |
| Rest day (normal) | `[redacted-path]/Downloads/trmnl-rest-day-DTZXFqYo.png` | `docs/mockups/rest-day.png` |
| Rest day (overdue) | `[redacted-path]/Downloads/trmnl-rest-day-overdue-CQA6HVEc.png` | `docs/mockups/rest-day-overdue.png` |
