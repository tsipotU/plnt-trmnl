...
- `docs/specs/2026-04-07-plant-trmnl-design.md` lines 223-224, 238-239, 640-643 — references to `/Users/admin/Downloads/trmnl-1-plant-BjV-4oWY.png`. Either relocate referenced images to `docs/mockups/` (some already exist there), or update the paths to be relative/sanitized.
- `docs/plans/2026-04-07-plant-trmnl-plan.md` lines 108, 112, 116 — references to `/Users/admin/Projects/baristi-v2/.agents/goals/build-app.md`. Rewrite as "adapt the ATLAS workflow from a related project" without the absolute path. `baristi-v2` is a private repo; its existence doesn't need to surface in a public doc.
