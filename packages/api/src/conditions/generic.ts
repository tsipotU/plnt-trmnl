/**
 * #75 — Generic plant conditions that apply to any species.
 *
 * Used by the PlantDetail "Add condition" picker as the "Common to any plant"
 * section. The species-specific section is sourced from the catalog (#3).
 *
 * Each entry mirrors the shape POSTed to /api/plants/:id/conditions.
 */
