...
function isValidEnrichmentBody(body: unknown): body is Omit<EnrichmentCallbackBody, 'plant_id'> {
  if (!body || typeof body !== 'object') return false;
  const b = body as Record<string, unknown>;
  return (
    typeof b.base_interval === 'number' &&
    typeof b.water_ratio === 'number' &&
    typeof b.water_description === 'string' &&
    typeof b.fertilizer_interval_weeks === 'number' &&
    typeof b.heating_season_modifier === 'number' &&
    Array.isArray(b.calibration_questions) &&
    Array.isArray(b.common_conditions) &&
